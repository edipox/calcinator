defmodule Calcinator.Resources.Sorts do
  ...
  """
  @spec from_alembic_fetch(Alembic.Fetch.t, Sort.from_alembic_fetch_sort_options) :: {:ok, t | nil} | FromJson.error
  ...
  @spec to_alembic_fetch_sorts(t, Resources.t) ::
          {:ok, Alembic.Fetch.Sorts.t} | FromJson.error
